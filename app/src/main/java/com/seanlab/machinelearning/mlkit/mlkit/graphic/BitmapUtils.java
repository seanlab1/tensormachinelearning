...
public class BitmapUtils {
  ...
  @Nullable
  public static Bitmap getBitmap(ByteBuffer data, com.seanlab.machinelearning.mlkit.mlkit.graphic.FrameMetadata metadata) {
    data.rewind();
  ...
  public static Bitmap getBitmap(ImageProxy image) {
    com.seanlab.machinelearning.mlkit.mlkit.graphic.FrameMetadata frameMetadata =

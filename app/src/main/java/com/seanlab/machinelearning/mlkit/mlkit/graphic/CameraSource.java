...
public class CameraSource {
  ...
  private final com.seanlab.machinelearning.mlkit.mlkit.graphic.GraphicOverlay graphicOverlay;
  ...
  public CameraSource(Activity activity, com.seanlab.machinelearning.mlkit.mlkit.graphic.GraphicOverlay overlay) {
        ...
        try {
          synchronized (processorLock) {
            frameProcessor.processByteBuffer(
                data,
                new com.seanlab.machinelearning.mlkit.mlkit.graphic.FrameMetadata.Builder()

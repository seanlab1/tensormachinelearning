...
package com.seanlab.machinelearning.mlkit.mlkit.graphic;
...
public class CameraSourcePreview extends ViewGroup {
  ...
  private com.seanlab.machinelearning.mlkit.mlkit.graphic.CameraSource cameraSource;

  private com.seanlab.machinelearning.mlkit.mlkit.graphic.GraphicOverlay overlay;
  ...
  private void start(com.seanlab.machinelearning.mlkit.mlkit.graphic.CameraSource cameraSource) throws IOException {
  ...
  public void start(com.seanlab.machinelearning.mlkit.mlkit.graphic.CameraSource cameraSource, com.seanlab.machinelearning.mlkit.mlkit.graphic.GraphicOverlay overlay) throws IOException {
  ...
  private void startIfReady() throws IOException, SecurityException {
    if (startRequested && surfaceAvailable) {
      ...
      if (overlay != null) {
        ...
        boolean isImageFlipped = cameraSource.getCameraFacing() == com.seanlab.machinelearning.mlkit.mlkit.graphic.CameraSource.CAMERA_FACING_FRONT;
        if (isPortraitMode()) {

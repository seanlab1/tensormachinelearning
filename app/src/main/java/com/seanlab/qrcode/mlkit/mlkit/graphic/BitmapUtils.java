...
public class BitmapUtils {
  ...
  @Nullable
  public static Bitmap getBitmap(ByteBuffer data, com.seanlab.qrcode.mlkit.mlkit.graphic.FrameMetadata metadata) {
    data.rewind();
  ...
  public static Bitmap getBitmap(ImageProxy image) {
    com.seanlab.qrcode.mlkit.mlkit.graphic.FrameMetadata frameMetadata =

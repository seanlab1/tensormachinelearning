...
public class CameraSource {
  ...
  private final com.seanlab.qrcode.mlkit.mlkit.graphic.GraphicOverlay graphicOverlay;
  ...
  public CameraSource(Activity activity, com.seanlab.qrcode.mlkit.mlkit.graphic.GraphicOverlay overlay) {
        ...
        try {
          synchronized (processorLock) {
            frameProcessor.processByteBuffer(
                data,
                new com.seanlab.qrcode.mlkit.mlkit.graphic.FrameMetadata.Builder()

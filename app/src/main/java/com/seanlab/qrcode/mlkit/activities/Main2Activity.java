...
import com.seanlab.qrcode.mlkit.tensorflow.FileSelection;
  ...
  protected void onCreate(@Nullable Bundle bundle) {
    ...
    Item1Button.setOnClickListener(new Button.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        activity.startActivity(new Intent(activity, com.seanlab.qrcode.mlkit.activities.CameraBarCodeActivity.class));
      }
    });
    Item2Button.setOnClickListener(new Button.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        //activity.startActivity(new Intent(activity, com.seanlab.qrcode.mlkit.activities.MainActivity.class));
        //activity.startActivity(new Intent(activity, com.seanlab.qrcode.mlkit.tensorflow.FileSelection.class));
        activity.startActivity(new Intent(activity, com.seanlab.qrcode.mlkit.tensorflow.ClassifierActivity.class));
      }
    });
    Item3Button.setOnClickListener(new Button.OnClickListener() {
      ...
      public void onClick(View view) {
        // TODO : click event
        Activity activity = Main2Activity.this;
        activity.startActivity(new Intent(activity, com.seanlab.qrcode.mlkit.activities.CustomObjectDetectionActivity.class));
      }
    });
    Item4Button.setOnClickListener(new Button.OnClickListener() {
      ...
      public void onClick(View view) {
        // TODO : click event
        Activity activity = Main2Activity.this;
        activity.startActivity(new Intent(activity, com.seanlab.qrcode.mlkit.activities.TextRecognitionActivity.class));
      }
    });
    ...
    Item5Button.setOnClickListener(new Button.OnClickListener() {
      ...
      public void onClick(View view) {
        // TODO : click event
        Activity activity = Main2Activity.this;
        activity.startActivity(new Intent(activity, com.seanlab.qrcode.mlkit.activities.CustomImageLabelingActivity.class));
      }
    });
    ...
    Item6Button.setOnClickListener(new Button.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        activity.startActivity(new Intent(activity, com.seanlab.qrcode.mlkit.activities.CustomAutoMLImageLabelingActivity.class));
      }
    });
